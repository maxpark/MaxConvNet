...
void flatten(
        DTYPE IN[P2_DOWNSIZE][P2_DOWNSIZE][C4_N_FILTERS],
        DTYPE OUT[FLAT_VEC_SZ]) {_ssdm_SpecArrayDimSize(IN, 4);_ssdm_SpecArrayDimSize(OUT, 512);
...
void vec_mat_mul_f1(
    ...
    const DTYPE W[F1_COLS][F1_ROWS],
    const DTYPE bias[F1_ROWS],
          DTYPE Z[F1_ROWS]) {_ssdm_SpecArrayDimSize(X, 512);_ssdm_SpecArrayDimSize(W, 512);_ssdm_SpecArrayDimSize(bias, 256);_ssdm_SpecArrayDimSize(Z, 256);
...
void vec_mat_mul_f2(
    ...
    const DTYPE W[F2_COLS][F2_ROWS],
    const DTYPE bias[F2_ROWS],
          DTYPE Z[F2_ROWS]) {_ssdm_SpecArrayDimSize(X, 256);_ssdm_SpecArrayDimSize(W, 256);_ssdm_SpecArrayDimSize(bias, 128);_ssdm_SpecArrayDimSize(Z, 128);
...
void vec_mat_mul_f3(
    ...
    const DTYPE W[F3_COLS][F3_ROWS],
    const DTYPE bias[F3_ROWS],
          DTYPE Z[F3_ROWS]) {_ssdm_SpecArrayDimSize(X, 128);_ssdm_SpecArrayDimSize(W, 128);_ssdm_SpecArrayDimSize(bias, 10);_ssdm_SpecArrayDimSize(Z, 10);
