...
void convolution_c1 (
        ...
        const DTYPE W[C1_W_DMNIN][C1_W_DMNIN][C1_N_CHAN][C1_N_FILTERS],
              DTYPE out[C1_OUT_DMNIN][C1_OUT_DMNIN][C1_N_FILTERS],
        const DTYPE bias[C1_N_FILTERS]) {_ssdm_SpecArrayDimSize(X, 32);_ssdm_SpecArrayDimSize(W, 5);_ssdm_SpecArrayDimSize(out, 28);_ssdm_SpecArrayDimSize(bias, 32);
...
void convolution_c2 (
        ...
        const DTYPE W[C2_W_DMNIN][C2_W_DMNIN][C2_N_CHAN][C2_N_FILTERS],
              DTYPE out[C2_OUT_DMNIN][C2_OUT_DMNIN][C2_N_FILTERS],
        const DTYPE bias[C2_N_FILTERS]) {_ssdm_SpecArrayDimSize(X, 28);_ssdm_SpecArrayDimSize(W, 5);_ssdm_SpecArrayDimSize(out, 24);_ssdm_SpecArrayDimSize(bias, 32);
...
void convolution_c3 (
        ...
        const DTYPE W[C3_W_DMNIN][C3_W_DMNIN][C3_N_CHAN][C3_N_FILTERS],
              DTYPE out[C3_OUT_DMNIN][C3_OUT_DMNIN][C3_N_FILTERS],
        const DTYPE bias[C3_N_FILTERS]) {_ssdm_SpecArrayDimSize(X, 12);_ssdm_SpecArrayDimSize(W, 3);_ssdm_SpecArrayDimSize(out, 10);_ssdm_SpecArrayDimSize(bias, 32);
...
void convolution_c4 (
        ...
        const DTYPE W[C4_W_DMNIN][C4_W_DMNIN][C4_N_CHAN][C4_N_FILTERS],
              DTYPE out[C4_OUT_DMNIN][C4_OUT_DMNIN][C4_N_FILTERS],
        const DTYPE bias[C4_N_FILTERS]) {_ssdm_SpecArrayDimSize(X, 10);_ssdm_SpecArrayDimSize(W, 3);_ssdm_SpecArrayDimSize(out, 8);_ssdm_SpecArrayDimSize(bias, 32);
