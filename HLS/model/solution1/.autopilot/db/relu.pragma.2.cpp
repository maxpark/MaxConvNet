...
void relu_a1(DTYPE in[A1_ROWS][A1_COLS][C1_N_FILTERS], DTYPE out[A1_ROWS][A1_COLS][C1_N_FILTERS]) {_ssdm_SpecArrayDimSize(in, 28);_ssdm_SpecArrayDimSize(out, 28);
...
void relu_a2(DTYPE in[A2_ROWS][A2_COLS][C2_N_FILTERS], DTYPE out[A2_ROWS][A2_COLS][C2_N_FILTERS]) {_ssdm_SpecArrayDimSize(in, 24);_ssdm_SpecArrayDimSize(out, 24);
...
void relu_a3(DTYPE in[A3_ROWS][A3_COLS][C3_N_FILTERS], DTYPE out[A3_ROWS][A3_COLS][C3_N_FILTERS]) {_ssdm_SpecArrayDimSize(in, 10);_ssdm_SpecArrayDimSize(out, 10);
...
void relu_a4(DTYPE in[A4_ROWS][A4_COLS][C4_N_FILTERS], DTYPE out[A4_ROWS][A4_COLS][C4_N_FILTERS]) {_ssdm_SpecArrayDimSize(in, 8);_ssdm_SpecArrayDimSize(out, 8);
...
void relu_a5(DTYPE in[F1_ROWS], DTYPE out[F1_ROWS]) {_ssdm_SpecArrayDimSize(in, 256);_ssdm_SpecArrayDimSize(out, 256);
...
void relu_a6(DTYPE in[F2_ROWS], DTYPE out[F2_ROWS]) {_ssdm_SpecArrayDimSize(in, 128);_ssdm_SpecArrayDimSize(out, 128);
