...
// conv1
const uint8_t C1_N_CHAN = 3;//����ͨ����
const uint8_t C1_X_DMNIN = 32;//ͼƬ��С
const uint8_t C1_W_DMNIN = 5;//5*5�����
const uint8_t C1_OUT_DMNIN = 28;
const uint8_t C1_N_FILTERS = 32;//�����filter
...
// conv3
const uint8_t C3_N_CHAN = 32;//����ͨ����
const uint8_t C3_X_DMNIN = 12;//ͼƬ��С
const uint8_t C3_W_DMNIN = 3;//5*5�����
const uint8_t C3_OUT_DMNIN = 10;
const uint8_t C3_N_FILTERS = 32;//�����filter
